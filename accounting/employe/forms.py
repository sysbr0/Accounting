...
class EmployeeForm(forms.ModelForm):
    class Meta:
        model = Employee
        fields = ['name', 'position', 'age', 'tc', 'title', 'state', 'is_working']  # Specify which fields you want in the form
        widgets = {
            ...
            'is_working': forms.CheckboxInput(attrs={'class': 'form-check-input', 'id': 'activeCheck'}),  # Example for checkbox input with custom class
        }
